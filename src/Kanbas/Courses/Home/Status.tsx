...
import { FaDownload, FaExchangeAlt, FaHome, FaChartBar, FaBullhorn, FaChartLine, FaBell } from 'react-icons/fa';

export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "300px" }} className="ms-5 me-2">
      <h2>Course Status</h2>
