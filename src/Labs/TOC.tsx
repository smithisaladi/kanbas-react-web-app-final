  ...
  return (
    <ul className="nav nav-pills">
      ...
      <li className="nav-item">
        <a id="wd-github" href="https://github.com/smithisaladi/kanbas-react-web-app-final" className="nav-link">
          GitHub-React
        </a>
      </li>
      <li className="nav-item">
        <a id="wd-github" href="https://github.com/smithisaladi/kanbas-node-server-app-final" className="nav-link">
          GitHub-Node
        </a>
      </li>
    </ul>
